...
if args.run:
    invoke('cargo run')
    invoke('cargo run', env={'RUST_LOG': 'info'})
    invoke('cargo run', env={'RUST_LOG': 'rust_log=info'})
    invoke('cargo run', env={'RUST_LOG': 'rust_log::inner=info'})
    invoke('cargo run', env={'RUST_LOG': 'rust_log::inner::center=info'})
